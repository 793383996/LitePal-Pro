package org.litepal.sampletest.test.crud.update

import android.content.ContentValues
import android.database.sqlite.SQLiteException
import androidx.test.filters.SmallTest
import org.litepal.sampletest.model.*
...
class UpdateUsingUpdateMethodKotlinTest : LitePalTestCase() {
    ...
    fun testUpdateToDefaultValueWithInstanceUpdateButWrongField() {
        try {
            ...
            assertEquals(
                    "The name field in org.litepal.sampletest.model.Teacher class is necessary which does not exist.",
                    e.message)
        }
    ...
    fun testUpdateWithInstanceUpdateWithConstructor() {
        try {
            ...
            assertEquals("org.litepal.sampletest.model.Computer needs a default constructor.",
                    e.message)
        }
